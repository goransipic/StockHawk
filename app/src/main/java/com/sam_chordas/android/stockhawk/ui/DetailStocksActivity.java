...
public class DetailStocksActivity extends AppCompatActivity implements
        OnChartGestureListener, OnChartValueSelectedListener ,LoaderManager.LoaderCallbacks<Cursor>{
...
//        mChart.centerViewTo(20, 50, AxisDependency.LEFT);
    ...
    private void setData(Cursor data) {
        ...
        while (data.moveToNext()) {
            ...
            values.add(new Entry(x++,Float.parseFloat(s)));
        }
        ...
        if (mChart.getData() != null &&
            ...
            set1 = new LineDataSet(values, "Stock values");
